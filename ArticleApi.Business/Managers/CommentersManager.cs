...
{
    public class CommentersManager : ICommentersService
    {
        private readonly ICommentersDal _repos;
        private readonly ILogsService _logs;

        public CommentersManager(ICommentersDal repos, ILogsService logs)
        {
            _repos = repos;
            _logs = logs;
        }
